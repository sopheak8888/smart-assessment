                    ...
                    >
                        ...
                        >
                            <div class="mx-auto w-full max-w-[440px]">
                                ...
                                <form class="space-y-5 dark:text-white mb-10 md:mb-[60px]" method="POST" action="{{ route('register') }}">
                                    @csrf
                                    <div>
                                        <label for="name" class="col-md-4 col-form-label text-md-end">{{ __('Name') }}</label>
                                        <div class="relative text-white-dark">
                                            <input id="Name" type="text" placeholder="Enter Name" class="form-input ps-10 placeholder:text-white-dark" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus>
                                    ...
                                    <div>
                                        ...
                                        <div class="relative text-white-dark">
                                            <input id="Email" type="email" placeholder="Enter Email" class="form-input ps-10 placeholder:text-white-dark" name="email" value="{{ old('email') }}" required autocomplete="email" />
                                            <span class="absolute start-4 top-1/2 -translate-y-1/2">
                                                <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
                                                    <path
                                                        opacity="0.5"
