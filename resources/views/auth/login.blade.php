                    ...
                    >
                        ...
                        >
                            <div class="mx-auto w-full max-w-[440px]">
                                ...
                                <form class="space-y-5 dark:text-white mb-10 md:mb-[60px]" method="POST" action="{{ route('login') }}">
                                    @csrf
                                    <div>
                                        <label for="email" class="col-md-4 col-form-label text-md-end">{{ __('Email Address') }}</label>
                                        <div class="relative text-white-dark">
                                            <input id="email" type="email" class="form-input ps-10 placeholder:text-white-dark" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus>
